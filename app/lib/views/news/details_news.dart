...
import 'package:dormshub/model/news.dart';
import 'package:flutter/material.dart';
...
class DetailsNews extends StatefulWidget {
  @override
  _DetailsState createState() => _DetailsState(news: news);

  News news;

  DetailsNews({this.news});
}

class _DetailsState extends State<DetailsNews> {
  News news;
  _DetailsState({this.news});
